...
using System.Text;
using static backend.Core.Services.AuthServices;

namespace backend.Core.Services
{

    //Keto metodat ne AuthServices merren prej IAuthServices
    public class AuthServices : IAuthServices
    {
        ...
        public AuthServices(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, ILogServices logServices, IConfiguration configuration)
        {
